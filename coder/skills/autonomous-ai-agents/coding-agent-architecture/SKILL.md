...
### Token Economics: Skills vs Always-Loaded Context

- Skill file: ~53 tokens/turn (name + description only in context)
- Equivalent CLAUDE.md / AGENTS.md section: 944+ tokens/turn (always loaded)
- For a 20-session project, this saves potentially **100K+ tokens** of wasted context
